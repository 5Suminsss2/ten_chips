      ...
      {open && (
        ...
        >
          ...
          <input
            ...
            placeholder="암호 입력"
          />
          {error && <p className="mt-1.5 text-[11px] font-semibold text-[#b5121b]">암호가 올바르지 않습니다.</p>}
          <button type="submit" className="mt-2 w-full bg-black py-2 text-xs font-bold uppercase tracking-[.16em] text-white transition hover:bg-[#b5121b]">로그인</button>
        </form>
      )}
    </div>
  );
