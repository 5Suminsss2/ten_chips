...
export function TrackCard({ track, index, dimmed }: { track: Track; index: number; dimmed?: boolean }) {
  return (
    <div className={`flex h-full flex-col overflow-hidden border border-black/15 bg-[#f3efe7] p-5 text-left shadow-[0_18px_44px_rgba(28,22,16,.18)] md:p-6 ${dimmed ? "blur-[1px]" : ""}`}>
